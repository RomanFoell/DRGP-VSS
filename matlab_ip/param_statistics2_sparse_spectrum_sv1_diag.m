function [C,zeta,Z,norm] = param_statistics2_sparse_spectrum_sv1_diag(Mu,Sigma,Sigma_S,Y_M,hypi,config)

% automatic relevance detemination (ard)

repmat_hypi_quad_mm = repmat(hypi.^2./(2^2),config.mm,1); % coming from / 2^Q
