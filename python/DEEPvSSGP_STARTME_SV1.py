...
#owd = '/usr/local/home/DRGP_VSS/python'

import os;
os.chdir(owd)
from DEEPvSSGP_opt_SV1 import DEEPvSSGP_opt
...
opt_params = {'hyp': hyp, 'MU_S': MU_S, 'MU': MU, 'SIGMA': SIGMA} # optimized parameters
fixed_params = {'MEAN_MAP': MEAN_MAP, 'b': b, 'sn': sn, 'sf': sf, 'U': U, 'SIGMA_S': SIGMA_S} # other not optimized parameters
...
os.chdir("..")
sio.savemat('matlab/data_optimized/test_SV1.mat', {'opt_params': opt_params1})
