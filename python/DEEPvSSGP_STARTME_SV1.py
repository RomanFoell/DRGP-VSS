...
fixed_params = {'b': b, 'sn': sn, 'sf': sf, 'U': U, 'SIGMA_S': SIGMA_S} # other not optimized parameters
...
os.chdir("..")
sio.savemat('matlab/data_optimized/DRGP_VSS_drive.mat', {'opt_params': opt_params1})
