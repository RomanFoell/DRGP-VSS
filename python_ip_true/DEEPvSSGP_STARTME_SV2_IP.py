...
opt_params = {'hyp': hyp, 'S': S, 'U': U, 'MU': MU, 'SIGMA': SIGMA} # optimized parameters
fixed_params = {'w': w, 'MEAN_MAP': MEAN_MAP, 'b': b, 'sn': sn, 'sf': sf} # other not optimized parameters
...
os.chdir("..")
sio.savemat('matlab_ip_true/data_optimized/' + 'SV2_IP_' + dataset + run, {'opt_params': opt_params1})
